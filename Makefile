all: makeQuiz Map/VisualStudio/MapColors/XmlQuizData.cs Quiz/React/quiz/public/map_api.js Quiz/NodeJS/public/map_api.js Quiz/NodeJS/public/jquery.min.js Quiz/React/quiz/public/jquery.min.js Map/NodeJS/arial.ttf
