...
namespace map_server
{
    ...
    public:
        LineItem(int id, int resolutionCount, IMap *iMap, bool cap1Round, bool cap2Round) :
            MultipointsItem(id, resolutionCount, iMap), _cap1Round(cap1Round), _cap2Round(cap2Round) {}
