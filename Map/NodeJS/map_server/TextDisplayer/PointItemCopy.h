...
namespace map_server
{
    ...
    public:
        PointItemCopy(const std::string& elementId, double importance, double x, double y, double diameter) :
            ItemCopy(elementId, importance), _x(x), _y(y), _diameter(diameter) {}
