...
namespace map_server
{
    ...
    LineItem::LineItem(const MultipointItem *multipointItem, const PolygonLook *polygonLook, int resolutionIndex) :
        ...
        _lineSize(polygonLook->getContourSize()), _pointList(multipointItem->getPointList(resolutionIndex))
    {
    }
