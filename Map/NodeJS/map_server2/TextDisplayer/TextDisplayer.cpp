...
namespace map_server
{
    ...
    TextPotential TextDisplayer::getTextPotential(MapItem *item, TextInfo *textInfo, double x, double y, bool selfRepulsion)
    {
    ...
    Potential TextDisplayer::getElementaryPotential(MapItem *item, double x, double y)
    {
        Potential potential;
