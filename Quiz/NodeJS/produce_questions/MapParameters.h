...
namespace produce_questions
{
    ...
    public:
        MapParameters(int framingLevel, const MapSubParameters *questionParameters, const MapSubParameters *answerParameters, const MapSubParameters *wrongChoiceParameters) :
            _framingLevel(framingLevel), _questionParameters(questionParameters), _answerParameters(answerParameters), _wrongChoiceParameters(wrongChoiceParameters) {}
        ~MapParameters();
