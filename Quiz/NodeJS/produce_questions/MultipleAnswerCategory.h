...
namespace produce_questions
{
    ...
    class MultipleAnswerCategory : public Category
    {
    private:
    ...
    public:
        MultipleAnswerCategory(unsigned int weightIndex, const MapParameters *mapParameters, int questionCount, const std::string& questionListId, int choiceCount,
